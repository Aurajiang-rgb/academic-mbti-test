...
export const RESULT_MAP = {
  CISl: {
    ...
    desc: '导师不疼，SCI 不爱。主打陪伴式读研/博,但是是个聪明蛋子。对科研最大贡献是维持了实验室的二氧化碳浓度，但是对世界的贡献肯定不止于此。',
    mbti: 'INFP/ISFP',
    match: 80,
  ...
  CIPr: {
    ...
    desc: '常年在实验室阴暗爬行。看似精神崩溃，全靠对命运的愤怒在疯狂写代码出图。每一篇Paper都写满怨气。',
    mbti: 'INTP',
    match: 90,
  ...
  CPPr: {
    title: '卷王之王 (疯批版)',
    tags: '卷死同行 | 极限微操 | 既要又要',
    desc: '所有研究生的噩梦。产出惊人且精神状态处于诡异的亢奋中。别人是来上学的，你是来渡劫飞升的。',
    mbti: 'ENTJ',
    match: 99,
